...
| Technology | Purpose |
|---|---|
| HTML5 / CSS3 | Structure & responsive styling |
| Vanilla JavaScript (ES6+) | Game engine, DOM updates, localStorage |
| CSS Custom Properties | Two-theme system (casino / dark) |
| localStorage API | Persist bankroll and stats |
